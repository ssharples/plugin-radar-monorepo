#!/usr/bin/env node
/**
 * Simple AI Parameter Map Generator
 *
 * Uses Claude API directly (no SDK dependency) to generate parameter maps
 * for plugins that don't have them yet.
 *
 * Usage:
 *   ANTHROPIC_API_KEY=sk-... node scripts/generate-parameter-maps-simple.mjs
 */
...
if (!ANTHROPIC_API_KEY) {
  ...
  console.error('Usage: ANTHROPIC_API_KEY=sk-... node scripts/generate-parameter-maps-simple.mjs');
  process.exit(1);
}
...
async function main() {
  console.log('🤖 AI Parameter Map Generator (Simple Version)\n');
