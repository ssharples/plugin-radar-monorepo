  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto px-4 lg:px-6 py-10 relative">
        <p className="text-xs text-stone-500 uppercase tracking-wider mb-3">Head to Head</p>
        <h1
        ...
        <p className="text-stone-400 mb-8">
          Honest, detailed breakdowns of competing plugins. Sound quality, workflow, CPU load, and value — compared side by side.
        </p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filtered.map(comparison => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-stone-100 group-hover:text-white transition">
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-stone-100 mb-2">No comparisons in this category</h3>
            <p className="text-stone-400">Try selecting a different category or check back as we add new comparisons.</p>
          </div>
        )}
      </div>
    </div>
